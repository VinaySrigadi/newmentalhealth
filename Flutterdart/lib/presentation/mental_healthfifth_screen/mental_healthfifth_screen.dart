...
class MentalHealthAssessmenfifthScreen extends StatefulWidget {
   final String username;
   
  const MentalHealthAssessmenfifthScreen({required this.username});

 

  @override
  _MentalHealthAssessmenfifthScreenState createState() => _MentalHealthAssessmenfifthScreenState();
}
...
class _MentalHealthAssessmenfifthScreenState extends State<MentalHealthAssessmenfifthScreen> {
            ...
            body: Container(
                ...
                child: Column(children: [
                  Container(
                      ...
                      child: Text("Are you Taking any medications?",
                          maxLines: 2,
