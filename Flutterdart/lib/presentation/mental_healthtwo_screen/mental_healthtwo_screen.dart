...
class MentalHealthAssessmentwoScreen extends StatefulWidget {
   final String username;
   
  const MentalHealthAssessmentwoScreen({required this.username});

 

  @override
  _MentalHealthAssessmentwoScreenState createState() => _MentalHealthAssessmentwoScreenState();
}
...
class _MentalHealthAssessmentwoScreenState extends State<MentalHealthAssessmentwoScreen> {
            ...
            body: Container(
                ...
                child: Column(children: [
                  Container(
                      ...
                      child: Text("What’s your Official Gender ?",
                          maxLines: 2,
  ...
  try {
    ...
    if (response.statusCode == 200) {
       ...
       Navigator.push(
        context,
        MaterialPageRoute(
          builder: (context) => MentalHealthAssessmenthreeScreen(username: username),
        ),
        );
  print("Updated");
